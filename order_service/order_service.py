...
print(f"Recebido pedido de encomenda para o utilizador {request.user_id} para o produto
{request.product_id}")
order_id = str(uuid.uuid4())
# 1. Chamar o serviço de pagamentos (gRPC Síncrono)
payment_request = ecommerce_pb2.PaymentRequest(order_id=order_id,
...
return ecommerce_pb2.CreateOrderResponse(order_id=order_id,

status="FALHOU_PAGAMENTO")
